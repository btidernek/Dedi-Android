...
import org.btider.dediapp.service.UpdateApkReadyListener;
...
public class UpdateApkJob extends ContextJob {
  ...
  private void handleDownloadStart(String uri, String versionName, byte[] digest) {
    ...
    downloadRequest.setTitle("Downloading Dedi update");
    downloadRequest.setDescription("Downloading Dedi " + versionName);
    downloadRequest.setVisibleInDownloadsUi(false);
    downloadRequest.setDestinationInExternalFilesDir(context, null, "dedi-update.apk");
