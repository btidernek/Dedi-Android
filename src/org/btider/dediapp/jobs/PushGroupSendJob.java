...
public class PushGroupSendJob extends PushSendJob implements InjectableType {
      ...
      EncapsulatedExceptions, UndeliverableMessageException
  {
    ...
    if (message.isGroup()) {
      ...
      SignalServiceGroup        group            = new SignalServiceGroup(type, GroupUtil.getDecodedId(groupId), groupContext.getName(), groupContext.getMembersList(),groupContext.getAdminsList(), avatar);
  ...
  private @NonNull List<Address> getGroupMessageRecipients(String groupId, long messageId) {
    ...
    if (!destinations.isEmpty()) return Stream.of(destinations).map(GroupReceiptDatabase.GroupReceiptInfo::getAddress).toList();
