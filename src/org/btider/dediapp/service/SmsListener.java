...
import org.btider.dediapp.jobs.SmsReceiveJob;
...
public class SmsListener extends BroadcastReceiver {
  ...
  private static final Pattern CHALLENGE_PATTERN = Pattern.compile( ".*(Dedi|TextSecure) doğrulama kodunuz:? ([0-9]{3,4})-([0-9]{3,4}).*", Pattern.DOTALL);
