...
import org.btider.dediapp.database.loaders.BucketedThreadMediaLoader;
...
import org.btider.dediapp.database.loaders.BucketedThreadMediaLoader.BucketedThreadMedia;
...
class MediaGalleryAdapter extends StickyHeaderGridAdapter {
  ...
  private final Set<MediaDatabase.MediaRecord>    selected;
