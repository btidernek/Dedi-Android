...
import org.btider.dediapp.contacts.ContactAccessor;
import org.btider.dediapp.contacts.ContactsDatabase;
import org.btider.dediapp.crypto.SessionUtil;
import org.btider.dediapp.database.Address;
import org.btider.dediapp.database.DatabaseFactory;
...
import org.btider.dediapp.recipients.Recipient;
import org.btider.dediapp.sms.IncomingJoinedMessage;
...
public class DirectoryHelper {
  ...
  public static RecipientDatabase.RegisteredState refreshDirectoryFor(@NonNull  Context context,
  ...
  private static Optional<AccountHolder> getOrCreateAccount(Context context) {
    ...
    Account[]      accounts       = accountManager.getAccountsByType("org.btider.dediapp");
  ...
  private static Optional<AccountHolder> createAccount(Context context) {
    AccountManager accountManager = AccountManager.get(context);
    Account        account        = new Account(context.getString(R.string.app_name), "org.btider.dediapp");
