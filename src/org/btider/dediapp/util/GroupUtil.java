...
//    private static List<Recipient> phoneNumbers = new ArrayList<>();
//    private static Integer temp_number = 0;
//    private static String deleteRec = null;
//    private static Recipient deleteReci = null;
...
//      if(temp_number > members.size()){
//        //Buradan
//         for(Recipient recipient : phoneNumbers){
//          boolean statu = false;
//          for(Recipient rec : members){
//            if(rec != null)
//              if(recipient != null)
//                if(rec.getAddress().equals(recipient.getAddress())){
//                  statu = true;
//                }
//          }
//          if(!statu){
...
//              phoneNumbers.clear();
//              deleteRec = recipient.toShortString()+"";
//              deleteReci = recipient;
//              break;
//            }
//          }
//        }
...
//
//
//          if(deleteReci.getAddress().equals(Address.fromSerialized(TextSecurePreferences.getLocalNumber(context)))) {
//            return context.getString(R.string.group_user_delete_me);
//          }
//          return deleteRec+" "+context.getString(R.string.group_user_delete);
//        }else{
//
//        }
//      }
//      temp_number = members.size();
//      phoneNumbers.clear();
//      phoneNumbers.addAll(members);
