package org.btider.dediapp.providers;
...
import org.btider.dediapp.crypto.ClassicDecryptingPartInputStream;
import org.btider.dediapp.crypto.ModernDecryptingPartInputStream;
...
public class PersistentBlobProvider {
  ...
  private static final String     URI_STRING            = "content://org.btider.dediapp/capture-new";
  public  static final Uri        CONTENT_URI           = Uri.parse(URI_STRING);
  public  static final String     AUTHORITY             = "org.btider.dediapp";
  ...
  public boolean delete(@NonNull Context context, @NonNull ArrayList<Uri> uris) {
    for(Uri uri : uris){
      switch (MATCHER.match(uri)) {
      case MATCH_OLD:
      case MATCH_NEW:
