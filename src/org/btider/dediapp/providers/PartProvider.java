...
import org.btider.dediapp.mms.PartUriParser;
import org.btider.dediapp.service.KeyCachingService;
import org.btider.dediapp.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.btider.dediapp/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.btider.dediapp", "part/*/#", SINGLE_ROW);
  }
