...
import static org.btider.dediapp.contactshare.ContactShareEditViewModel.*;
...
public class ContactShareEditActivity extends PassphraseRequiredActionBarActivity implements ContactShareEditAdapter.EventListener {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState, boolean ready) {
    ...
    viewModel = ViewModelProviders.of(this, new ContactShareEditViewModel.Factory(contactUris, contactRepository)).get(ContactShareEditViewModel.class);
  ...
  private void presentEvent(@Nullable ContactShareEditViewModel.Event event) {
    if (event == null) {
      return;
    }

    if (event == ContactShareEditViewModel.Event.BAD_CONTACT) {
