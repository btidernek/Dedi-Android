...
import org.btider.dediapp.components.InputAwareLayout.InputView;
...
public class QuickAttachmentDrawer extends ViewGroup implements InputView, CameraView.CameraViewListener {
  ...
  private void updateControlsView() {
    ...
    timeClock = (TextView) controls.findViewById(R.id.timeClock);
    timeClock.setVisibility(GONE);
  ...
  private class ShutterClickListener implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        cameraView.takePicture(previewRect,swapCameraButton);
    }
  ...
  private class ShutterLongClickListener implements OnLongClickListener {
    ...
    public boolean onLongClick(View v) {
        if (Build.VERSION.SDK_INT >= VERSION_CODES.M) {
            cameraView.takeVideo(shutterButton,swapCameraButton,drawerState,fullScreenButton,timeClock);
        }else
            Toast.makeText(getContext(),getContext().getString(R.string.video_record_not_android_version),Toast.LENGTH_LONG).show();
