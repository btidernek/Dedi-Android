...
public class BulkMessageConversationTitleView extends RelativeLayout {

  @SuppressWarnings("unused")
  private static final String TAG = BulkMessageConversationTitleView.class.getSimpleName();
  ...
  public BulkMessageConversationTitleView(Context context) {
    this(context, null);
  }

  public BulkMessageConversationTitleView(Context context, AttributeSet attrs) {
    super(context, attrs);
  ...
  public void setTitle(@NonNull GlideRequests glideRequests, @Nullable Recipient recipient) {
    ...
    if (recipient != null) {
      ...
      this.avatar.setVisibility(GONE);
    }
  }
  ...
  private void setContactRecipientTitle(Recipient recipient) {
    this.title.setText(R.string.bulk_message_conversation_title);
