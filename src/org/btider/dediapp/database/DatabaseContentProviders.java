...
public class DatabaseContentProviders {
    ...
    public static class ConversationList extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.btider.dediapp.database.conversationlist");
    }

    public static class Conversation extends NoopContentProvider {
        private static final String CONTENT_URI_STRING = "content://org.btider.dediapp.database.conversation/";
    ...
    public static class Attachment extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.btider.dediapp.database.attachment");
    }
