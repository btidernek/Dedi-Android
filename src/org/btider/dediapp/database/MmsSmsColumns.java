...
public interface MmsSmsColumns {
  ...
  public static class Types {
    ...
    public static boolean isGroupAddUser(long type) {
      return type == Long.parseLong(StaticFactoryBase.groupUserAdd);
    }

    public static boolean isGroupRemoveUser(long type) {
      return type == Long.parseLong(StaticFactoryBase.groupUserRemove);
    }
