...
import org.btider.dediapp.recipients.Recipient;
import org.btider.dediapp.util.DelimiterUtil;
...
public class ThreadDatabase extends Database {
  ...
  public List<MessagingDatabase.MarkedMessageInfo> setAllThreadsRead() {
    ...
    return new LinkedList<MessagingDatabase.MarkedMessageInfo>() {{
      addAll(smsRecords);
      addAll(mmsRecords);
    }};
  }

  public List<MessagingDatabase.MarkedMessageInfo> setUnRead(long threadId, boolean lastSeen) {
    ContentValues contentValues = new ContentValues(1);
