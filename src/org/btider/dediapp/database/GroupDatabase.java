...
public class GroupDatabase extends Database {
    ...
    public String getOrCreateGroupForMembers(List<Address> members, boolean mms) {
        ...
        try {
            if (cursor != null && cursor.moveToNext()) {
                ...
                // TODO FIXME BTK admins for mms group?
                create(groupId, null, members, members, null, null, null);
                return groupId;
            }
        } finally {
    ...
    public @NonNull
    List<Recipient> getGroupMembers(String groupId, boolean includeSelf) {
    ...
    //eklendi.
    public @NonNull
    List<Address> getAdmins(String groupId) {
        try (Cursor cursor = databaseHelper.getReadableDatabase().query(TABLE_NAME, new String[]{ADMINS},
                GROUP_ID + " = ?",
                new String[]{groupId},
                null, null, null)) {
            ...
            if (cursor != null && cursor.moveToFirst()) {
                String serializedMembers = cursor.getString(cursor.getColumnIndexOrThrow(ADMINS));
    ...
    public void create(@NonNull String groupId, @Nullable String title, @NonNull List<Address> members,
                       @NonNull List<Address> admins, @NonNull List<Address> removeUsers,
    ...
    public static class GroupRecord {
        ...
        public GroupRecord(String id, String title, String members, byte[] avatar,
                           ...
                           String relay, boolean active, byte[] avatarDigest, boolean mms, String admins)//admins eklendi.
        {
            this.id = id;
            this.title = title;
            this.avatar = avatar;
