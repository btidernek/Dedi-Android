...
public abstract class MessageRecord extends DisplayRecord {
  ...
  public SpannableString getDisplayBody() {
    if (isGroupCreate(id)&& isOutgoing()) {
      return emphasisAdded(context.getString(R.string.notification_group_you_created));
    } else if (isGroupCreate(id)) {
      return emphasisAdded(getIndividualRecipient().getName()+" "+context.getString(R.string.notification_group_created));
    } else if (isGroupUserRemove()) {
      return emphasisAdded(getBody()+" "+context.getString(R.string.notification_group_remove_member));
    } else if (isGroupUserAdd()) {
      return emphasisAdded(getBody()+" "+context.getString(R.string.notification_group_add_member));
