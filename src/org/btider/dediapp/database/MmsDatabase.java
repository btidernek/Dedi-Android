...
import org.btider.dediapp.attachments.MmsNotificationAttachment;
import org.btider.dediapp.contactshare.Contact;
import org.btider.dediapp.database.documents.IdentityKeyMismatch;
import org.btider.dediapp.database.documents.IdentityKeyMismatchList;
import org.btider.dediapp.database.documents.NetworkFailure;
import org.btider.dediapp.database.documents.NetworkFailureList;
import org.btider.dediapp.database.helpers.SQLCipherOpenHelper;
import org.btider.dediapp.database.model.MediaMmsMessageRecord;
import org.btider.dediapp.database.model.MessageRecord;
import org.btider.dediapp.database.model.NotificationMmsMessageRecord;
...
import org.btider.dediapp.database.model.NotificationMmsMessageRecord;
import org.btider.dediapp.database.model.Quote;
import org.btider.dediapp.jobs.TrimThreadJob;
...
import org.btider.dediapp.recipients.Recipient;
import org.btider.dediapp.recipients.RecipientFormattingException;
import org.btider.dediapp.util.JsonUtils;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.btider.dediapp.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  private @Nullable String getSerializedSharedContacts(long mmsId, @NonNull Map<Attachment, AttachmentId> insertedAttachmentIds, @NonNull List<Contact> contacts) {
    ...
    for (Contact contact : contacts) {
      try {
        ...
        Contact.Avatar updatedAvatar  = new Contact.Avatar(attachmentId,
  ...
  public class Reader {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.btider.dediapp.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.btider.dediapp.util.Util.toIsoBytes(transactionId);
