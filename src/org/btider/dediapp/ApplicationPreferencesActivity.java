...
import org.btider.dediapp.preferences.AdvancedPreferenceFragment;
import org.btider.dediapp.preferences.AppProtectionPreferenceFragment;
import org.btider.dediapp.preferences.AppearancePreferenceFragment;
import org.btider.dediapp.preferences.ChatsPreferenceFragment;
import org.btider.dediapp.preferences.CorrectedPreferenceFragment;
import org.btider.dediapp.preferences.NotificationsPreferenceFragment;
import org.btider.dediapp.preferences.SmsMmsPreferenceFragment;
import org.btider.dediapp.preferences.widgets.ProfilePreference;
...
////
////                      fragment[0] = new SmsMmsPreferenceFragment();
////
////                    }
////                  })
////                  .execute();
...
//          break;
                    case PREFERENCE_CATEGORY_NOTIFICATIONS:
                        fragment[0] = new NotificationsPreferenceFragment();
                        break;
                    case PREFERENCE_CATEGORY_APP_PROTECTION:
                        fragment[0] = new AppProtectionPreferenceFragment();
                        break;
                    case PREFERENCE_CATEGORY_APPEARANCE:
                        fragment[0] = new AppearancePreferenceFragment();
                        break;
                    case PREFERENCE_CATEGORY_CHATS:
                        fragment[0] = new ChatsPreferenceFragment();
                        break;
                    ...
                    case PREFERENCE_CATEGORY_ADVANCED:
                        fragment[0] = new AdvancedPreferenceFragment();
                        break;
                    default:
                ...
                if (fragment[0] != null) {
                    ...
                    fragmentTransaction.replace(android.R.id.content, fragment[0]);
