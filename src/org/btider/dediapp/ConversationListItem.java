...
import org.btider.dediapp.util.SpanUtil;
...
import static org.btider.dediapp.util.SpanUtil.color;
...
//    this.subjectView.setTypeface(read ? LIGHT_TYPEFACE : BOLD_TYPEFACE);
    ...
    if (thread.getDate() > 0) {
      ...
      dateView.setText(unreadCount == 0 ? date : SpanUtil.color(getResources().getColor(R.color.textsecure_primary_dark), date));
