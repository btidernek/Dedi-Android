...
import org.btider.dediapp.components.AlertView;
import org.btider.dediapp.components.AudioView;
import org.btider.dediapp.components.AvatarImageView;
import org.btider.dediapp.components.DeliveryStatusView;
import org.btider.dediapp.components.DocumentView;
import org.btider.dediapp.components.ExpirationTimerView;
import org.btider.dediapp.components.QuoteView;
import org.btider.dediapp.components.SharedContactView;
...
import org.btider.dediapp.database.model.Quote;
import org.btider.dediapp.jobs.AttachmentDownloadJob;
import org.btider.dediapp.jobs.MmsDownloadJob;
...
import org.btider.dediapp.mms.SlideClickListener;
...
import org.btider.dediapp.util.LongClickCopySpan;
import org.btider.dediapp.util.LongClickMovementMethod;
...
import org.btider.dediapp.util.dualsim.SubscriptionManagerCompat;
      ...
      if (messageRecord.isMmsNotification()) {
        ...
        ApplicationContext.getInstance(context)
                          ...
                          .add(new AttachmentDownloadJob(context, messageRecord.getId(),
                                                         ((DatabaseAttachment)slide.asAttachment()).getAttachmentId(), true,((DatabaseAttachment)slide.asAttachment()).getSize()));
      }
    }
  }
