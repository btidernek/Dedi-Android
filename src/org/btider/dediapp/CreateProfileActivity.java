...
import org.btider.dediapp.components.emoji.EmojiToggle;
...
import org.btider.dediapp.profiles.ProfileMediaConstraints;
import org.btider.dediapp.profiles.SystemProfileUtil;
...
import org.btider.dediapp.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private void initializeResources() {
    ...
    informationLabel.setOnClickListener(view -> {
      ...
      intent.setData(Uri.parse(getString(R.string.support_settings_link)));
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.btider.dediapp.action.CLEAR_PROFILE_PHOTO"));
    }
