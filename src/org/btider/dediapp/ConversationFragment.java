...
import org.btider.dediapp.contactshare.SharedContactDetailsActivity;
...
import org.btider.dediapp.database.loaders.ConversationLoader;
import org.btider.dediapp.database.model.MediaMmsMessageRecord;
...
import org.btider.dediapp.profiles.UnknownSenderView;
...
import org.btider.dediapp.util.SaveAttachmentTask;
...
import org.btider.dediapp.ConversationAdapter.ItemClickListener;
...
import org.btider.dediapp.util.CommunicationActions;
import org.btider.dediapp.util.SaveAttachmentTask;
import org.btider.dediapp.util.SaveAttachmentTask.Attachment;
import org.btider.dediapp.util.StickyHeaderDecoration;
import org.btider.dediapp.util.ViewUtil;
import org.btider.dediapp.util.task.ProgressDialogAsyncTask;
  ...
  implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  private InformationSecurityInfoView informationSecurityInfoView;
  private InfoView infoView;

  public void setInformationSecurityInfoView(InformationSecurityInfoView informationSecurityInfoView) {
    this.informationSecurityInfoView = informationSecurityInfoView;
  }
  ...
  //informationSecurityInfoViewStub.get().setVisibility(View.VISIBLE)
  @Override
  ...
  private void initializeListAdapter() {
    if (this.recipient != null && this.threadId != -1) {
      ...
      getLoaderManager().restartLoader(0, Bundle.EMPTY, this);
      if(informationSecurityInfoView != null)
        informationSecurityInfoView.setVisibility(View.GONE);
    }else{
      if(informationSecurityInfoView != null)
        informationSecurityInfoView.setVisibility(View.VISIBLE);
    }
  }
  ...
  // Bir mesaj seçilince tetiklenecek metot.
  ...
  private class ConversationScrollListener extends OnScrollListener {
    ...
    private void bindScrollHeader(ConversationAdapter.HeaderViewHolder headerViewHolder, int positionId) {
  ...
  private class ConversationFragmentItemClickListener implements ConversationAdapter.ItemClickListener {
    ...
    public void onInviteSharedContactClicked(@NonNull List<Recipient> choices) {
      ...
      ContactUtil.selectRecipientThroughDialog(getContext(), choices, locale, recipient -> {
        CommunicationActions.composeSmsThroughDefaultApp(getContext(), recipient.getAddress(), getString(R.string.InviteActivity_lets_switch_to_signal, getString(R.string.share_link)));
      });
    }
  }
