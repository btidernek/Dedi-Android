...
import org.btider.dediapp.components.FromTextView;
    ...
    implements RecipientModifiedListener
{
  ...
  public void set(final GlideRequests glideRequests,
                  ...
                  final MessageDetailsRecipientAdapter.RecipientDeliveryStatus member,
                                  ...
                                  final boolean isPushGroup)
  {
    ...
    if (keyMismatch != null) {
      ...
      if (record.isOutgoing()) {
        if (member.getDeliveryStatus() == MessageDetailsRecipientAdapter.RecipientDeliveryStatus.Status.PENDING || member.getDeliveryStatus() == MessageDetailsRecipientAdapter.RecipientDeliveryStatus.Status.UNKNOWN) {
          deliveryStatusView.setVisibility(View.GONE);
        } else if (member.getDeliveryStatus() == MessageDetailsRecipientAdapter.RecipientDeliveryStatus.Status.READ) {
          deliveryStatusView.setRead();
          deliveryStatusView.setVisibility(View.VISIBLE);
        } else if (member.getDeliveryStatus() == MessageDetailsRecipientAdapter.RecipientDeliveryStatus.Status.DELIVERED) {
          deliveryStatusView.setDelivered();
          deliveryStatusView.setVisibility(View.VISIBLE);
        } else if (member.getDeliveryStatus() == MessageDetailsRecipientAdapter.RecipientDeliveryStatus.Status.SENT) {
